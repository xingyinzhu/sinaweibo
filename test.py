...
def main():
	try:
		...
		APP_KEY = "4264282095"
		APP_SECRET = "0b5aebf33922768b66a5361017ad5e85"
		...
		#print client.post.statuses__update(status=u'my first weibo from python client')
		print client.upload.statuses__upload(status=u'my first weibo with a pic from python client', pic=open('me.jpg'))
